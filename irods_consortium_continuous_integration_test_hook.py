...
def main():
    ...
    irods_python_ci_utilities.install_os_packages_from_files(glob.glob(os.path.join(built_packages_root_directory, 'irods-rule-engine-plugin-audit-amqp*.{0}'.format(package_suffix) )))
